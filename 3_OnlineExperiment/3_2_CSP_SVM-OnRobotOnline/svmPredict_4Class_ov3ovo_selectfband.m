function PredictType = svmPredict_4Class_ov3ovo_selectfband(test_Fea,Y,svmModels)
% input: test_Fea: test_Fea generated by the Y-th csp.
    ...
    [predict_label_te_1,accuracy_te_1,prob_estimates_te_1] = svmpredict(Y,test_Fea{1}(:,fband_mdl_1),svmModels.Mdl_1,' -b 1');
    [predict_label_te_23,accuracy_te_23,prob_estimates_te_23] = svmpredict(Y,test_Fea{2}(:,fband_mdl_23),svmModels.Mdl_23,' -b 1');
    [predict_label_te_24,accuracy_te_24,prob_estimates_te_24] = svmpredict(Y,test_Fea{3}(:,fband_mdl_24),svmModels.Mdl_24,' -b 1');
    [predict_label_te_34,accuracy_te_34,prob_estimates_te_34] = svmpredict(Y,test_Fea{4}(:,fband_mdl_34),svmModels.Mdl_34,' -b 1');
    %%%%%%%%%%%%%%%
